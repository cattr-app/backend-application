...
Route::group([
    ...
    $router->middleware('auth:sanctum')->group(static function (Router $router) {
        ...
        $router->post('logout-from-all', [AuthController::class, 'logoutFromAll'])->name('auth.logout_all');
        ...
        $router->get('register/{key}', [RegistrationController::class, 'getForm'])->name('auth.register.form');
        $router->post('register/{key}', [RegistrationController::class, 'postForm'])->name('auth.register.process');
...
Route::group([
    ...
    $router->group(['middleware' => ['throttle:120,1']], static function (Router $router) {
        //Invitations routes
        $router->any('invitations/list', [InvitationController::class, 'index'])->name('invitations.list');
        $router->get('invitations/count', [InvitationController::class, 'count'])->name('invitations.count');
        $router->post('invitations/create', [InvitationController::class, 'create'])->name('invitations.create');
        $router->post('invitations/resend', [InvitationController::class, 'resend'])->name('invitations.resend');
        $router->post('invitations/show', [InvitationController::class, 'show'])->name('invitations.show');
        $router->post('invitations/remove', [InvitationController::class, 'destroy'])->name('invitations.destroy');

        //Priorities routes
        $router->any('priorities/list', [PriorityController::class, 'index'])->name('priorities.list');
        $router->get('priorities/count', [PriorityController::class, 'count'])->name('priorities.count');
        $router->post('priorities/create', [PriorityController::class, 'create'])->name('priorities.create');
        $router->post('priorities/edit', [PriorityController::class, 'edit'])->name('priorities.edit');
        $router->any('priorities/show', [PriorityController::class, 'show'])->name('priorities.show');
        $router->post('priorities/remove', [PriorityController::class, 'destroy'])->name('priorities.destroy');

        //Statuses routes
        $router->any('statuses/list', [ApiStatusController::class, 'index'])->name('statuses.list');
        $router->get('statuses/count', [ApiStatusController::class, 'count'])->name('statuses.count');
        $router->post('statuses/create', [ApiStatusController::class, 'create'])->name('statuses.create');
        $router->post('statuses/edit', [ApiStatusController::class, 'edit'])->name('statuses.edit');
        $router->any('statuses/show', [ApiStatusController::class, 'show'])->name('statuses.show');
        $router->post('statuses/remove', [ApiStatusController::class, 'destroy'])->name('statuses.destroy');

        //Projects routes
        $router->any('projects/list', [ProjectController::class, 'index'])->name('projects.list');
        $router->any('projects/count', [ProjectController::class, 'count'])->name('projects.count');
        $router->post('projects/create', [ProjectController::class, 'create'])->name('projects.create');
        $router->post('projects/edit', [ProjectController::class, 'edit'])->name('projects.edit');
        ...
        //Tasks routes
        $router->any('tasks/list', [TaskController::class, 'index'])->name('tasks.list');
        $router->any('tasks/count', [TaskController::class, 'count'])->name('tasks.count');
        $router->post('tasks/create', [TaskController::class, 'create'])->name('tasks.create');
        ...
        $router->any('users/count', [UserController::class, 'count'])->name('users.count');
        $router->post('users/create', [UserController::class, 'create'])->name('users.create');
        $router->post('users/edit', [UserController::class, 'edit'])->name('users.edit');
        $router->any('users/show', [UserController::class, 'show'])->name('users.show');
        $router->post('users/remove', [UserController::class, 'destroy'])->name('users.destroy');
        ...
        $router->any('roles/count', [RoleController::class, 'count'])->name('roles.count');

        // Statistic routes
        $router->post('report/project', [ProjectReportController::class, '__invoke'])->name('report.project');
        $router->post('report/project/download', [ProjectReportController::class, 'download'])->name('report.project.download');
        $router->post('report/time', [TimeUseReportController::class, '__invoke'])->name('report.time');
        $router->post('report/dashboard', [DashboardController::class, '__invoke'])->name('report.dashboard');
        $router->post('report/dashboard/download', [DashboardController::class, 'download'])->name('report.dashboard.download');

        // About
        $router->get('about', [AboutController::class, '__invoke'])->name('about.list');
        $router->get('about/storage', [AboutController::class, 'storage'])->name('about.storage');
        $router->post('about/storage', [AboutController::class, 'startStorageClean'])->name('about.storage.clean');

        $router->get('about/reports', [AboutController::class, 'reports'])->name('about.reports');

        //Company settings
        $router->get('company-settings', [CompanySettingsController::class, 'index'])->name('settings.list');
        $router->patch('company-settings', [CompanySettingsController::class, 'update'])->name('settings.save');
    });
